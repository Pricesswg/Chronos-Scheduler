      ...
      <div class="col" style="gap:22px">
        ...
        <div class="card">
          <div class="weekgrid">
            ...
            ${s.map((e,t)=>{const i=r.filter(e=>e.days[t]);return F`
              <div class="weekgrid__row">
                <div class="weekgrid__day" style="color:${t===n?"var(--accent)":""}">
                  ${e}${t===n?F`<span style="display:block;font-size:9px;margin-top:2px">${Ve("week.today").toUpperCase()}</span>`:Z}
                </div>
        ...
        <div class="row" style="gap:14px;flex-wrap:wrap">
          ${Object.entries(Qe).map(([e,t])=>{const i={on:Ve("schedule.active"),off:Ve("schedule.disabled"),set:Ve("common.value"),preset:"Preset",cmd:Ve("editor.block.action")};return F`
              <div class="row" style="gap:6px">
