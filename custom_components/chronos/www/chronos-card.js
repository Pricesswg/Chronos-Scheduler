              ...
              <div class="sched-card" data-selected="${e.id===this.card._selectedId}"
                ...
                <div class="sched-card__footer">
                  <div class="sched-card__devices">
                    ${i.slice(0,5).map(e=>{const t=Ee(e,this.card.hass?.states?.[e.entity_id],this.card._settings);return j`<div class="device-icon-pill" title="${e.alias}" style="background:${t.soft};color:${t.accent}">${we(e.type,14)}</div>`})}
                    ${i.length>5?j`<div class="device-icon-pill mono" style="font-size:10px">+${i.length-5}</div>`:G}
                  </div>
        ...
        <div class="sp-between" style="align-items:flex-start;flex-wrap:wrap;row-gap:10px">
          <div style="min-width:0;flex:1 1 280px">
            ...
            <div class="row" style="margin-top:6px;gap:10px;flex-wrap:wrap">
              ...
              ${"scene"!==a&&"automation"!==a?j`<span class="chip">${_e("device",11)} ${i.length}</span>`:G}
