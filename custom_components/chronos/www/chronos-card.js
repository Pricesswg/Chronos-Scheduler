                  ...
                  ${"scene"===a&&"activate"===t.action?.id?F`
                    <div class="device-row" style="border:1px solid var(--border-soft);border-radius:var(--r-md);padding:10px 12px;margin-top:2px">
                      <div class="device-row__main">
                        <div class="device-row__name">${Ve("editor.scene.on_demand.label")}</div>
                        <div class="device-row__meta" style="font-family:var(--font-sans);white-space:normal">${Ve("editor.scene.on_demand.hint")}</div>
                      </div>
                      <label class="switch">
                        <input type="checkbox" .checked=${"on_demand"===t.action?.mode}
                          @change=${t=>this._setSceneOnDemand(e.id,t.target.checked)}/>
                        <span class="switch__track"></span>
                        <span class="switch__thumb"></span>
                      </label>
                    </div>
