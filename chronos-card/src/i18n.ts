...
const STRINGS: Record<string, Record<BaseLang, string>> = {
  ...
  "live.map.subtitle": { it: "Radar pioggia RainViewer · mappa CARTO", en: "RainViewer rain radar · CARTO basemap", fr: "Radar de pluie RainViewer · fond CARTO", de: "RainViewer-Regenradar · CARTO-Karte" },
  ...
  "settings.live.map.desc": { it: "Mappa interattiva con radar pioggia nella schermata Live. Tile CARTO e radar RainViewer vengono scaricati da internet alla visualizzazione: disattiva per installazioni offline.", en: "Interactive map with rain radar on the Live screen. CARTO basemap tiles and the RainViewer radar are fetched from the internet at view time: turn off for offline installations.", fr: "Carte interactive avec radar de pluie sur l'écran en direct. Les tuiles CARTO et le radar RainViewer sont téléchargés à l'affichage : désactivez pour les installations hors ligne.", de: "Interaktive Karte mit Regenradar in der Live-Ansicht. CARTO-Kacheln und das RainViewer-Radar werden beim Anzeigen aus dem Internet geladen: für Offline-Installationen abschalten." },
